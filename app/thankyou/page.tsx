                ...
                <div className="mag-panel rounded-3xl p-10 shadow-2xl flex flex-col items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="mag-text-muted text-sm leading-relaxed">
                            We received your details. You&apos;re on the list for our premium service—AI-led product ads
                            and managed creator accounts. We&apos;ll email you when we&apos;re ready with next steps.
                        </p>
                    </div>
